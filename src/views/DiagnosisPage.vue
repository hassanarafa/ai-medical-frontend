      ...
      <transition name="fade-transform" mode="out-in">
        ...
        <div v-if="!result" class="glass-card" :key="'wizard'">
          ...
          <div class="step-body">
            <template v-if="currentStep === 0">
              <div class="upload-zone" :class="{ 'has-image': image, 'is-scanning': loading }"
                @click="!loading && $refs.imageInput.click()">
        ...
        <div v-else class="result-dashboard" :key="'result'">
          ...
          <div class="report-footer">
            <p class="legal">This analysis is AI-generated for guidance and does not replace professional medical
              consultation.
            </p>
...
.wizard-container {
  ...
  height: 100vh;
  overflow-y: auto;
  /* Enables scrolling for long forms */
  overflow-x: hidden;
...
.main-content {
  ...
  width: 100%;
  max-width: 580px;
  /* Limits desktop width for readability */
  box-sizing: border-box;
}
...
@media (max-width: 500px) {
  ...
  .card-footer {
    ...
    /* Stack "Back" under the main buttons */
    gap: 20px;
  }
